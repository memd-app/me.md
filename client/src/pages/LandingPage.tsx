...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-bg scroll-smooth">
      {/* ───── Header / Navigation ───── */}
      ...
      {/* ───── Hero Section ───── */}
      <section id="hero" className="max-w-6xl mx-auto px-4 py-20 md:py-28 text-center">
        <div className="inline-block mb-6 px-4 py-1.5 rounded-full bg-primary-50 dark:bg-primary-950 text-primary-700 dark:text-primary-300 text-sm font-medium">
          Closed Beta — Limited Spots Available
        </div>
        <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
          Your Verified Personal Context
        </h1>
        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-4 leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={pillar.title} className="card text-center relative">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={feature.label}
                className="p-5 rounded-xl bg-gray-50 dark:bg-dark-surface border border-gray-100 dark:border-dark-border hover:border-primary-200 dark:hover:border-primary-800 transition-colors"
              >
      ...
      <section id="social-proof" className="bg-gray-50 dark:bg-dark-surface py-20">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-16">
            {[
              ...
              <div key={stat.label} className="text-center p-6 rounded-xl bg-white dark:bg-dark-bg">
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400">{stat.note}</div>
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={idx}
                className="p-6 rounded-xl bg-white dark:bg-dark-bg border border-gray-100 dark:border-dark-border"
              >
                <svg
      ...
      <section id="waitlist" className="bg-primary-600 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          {waitlistSubmitted ? (
            <div className="inline-flex items-center gap-2 bg-white/20 text-white px-6 py-3 rounded-lg font-medium">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full sm:w-auto whitespace-nowrap bg-white text-primary-600 px-6 py-3 rounded-lg font-semibold hover:bg-primary-50 transition-colors focus:outline-none focus:ring-2 focus:ring-white"
              >
                Join Waitlist
              </button>
            </form>
