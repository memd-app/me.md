      ...
      <div className="w-full max-w-md">
        ...
        <div className="card">
          {submitted ? (
            ...
            <>
              {error && (
                <div id="forgot-password-error" className="mb-5 p-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 text-sm flex items-start gap-2" role="alert" aria-live="assertive">
